...
void hello(int pid)
{
  ...
  void *dlmalloc_ptr = dlmalloc(sizeof(int));
  ...
  printf("the physical address of heap variable malloc_ptr   is %p\n", my_get_physical_addresses(malloc_ptr));
  printf("the offset of the logical address of heap variable dlmalloc_ptr is %p, ", dlmalloc_ptr);
  printf("the physical address of heap variable dlmalloc_ptr is %p\n", my_get_physical_addresses(dlmalloc_ptr));
  // local variable
